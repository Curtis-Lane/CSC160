...
namespace GoblinsGUIsTheWinFormsChronicles.Controllers {
	public class CombatSystem : ICombatManager {
		...
		public (UI.Character player, UI.Character enemy) GetCombatants() {
		...
		UI.Character CharacterToUI(Characters.Character characterToConvert) {
			UI.Character character = new UI.Character();
